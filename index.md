...
- **项目2：民航数据分析（2018年11月）**
&emsp;项目描述：使用MapRecduce对数据进行清洗，统计出最繁忙的机场Top10、最受欢迎的航线、最大的代理人TOP10、某一天的各个机场的卖出数据Top10，并用图表展示。
- **项目3：信息技术手册（2019年1月~2019年4月）**
&emsp;项目描述：帮助政府机关编写信息技术手册，普及信息领域基本的知识。
- **项目4：纺织布匹表面瑕疵识别系统（2019年3月~2019年6月）**
&emsp;项目描述：通过图像处理、纹理识别、信息融合，深度学习等技术，对产品质检过程中高速相机抓取的瑕疵图像数据进行瑕疵类型大数据建模，对瑕疵图像相关信息进行学习与记忆存储，不断优化疵点的检测和分类。
&emsp;主要任务：完成疵点识别与分类。
